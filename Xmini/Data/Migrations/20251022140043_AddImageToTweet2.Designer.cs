...
namespace Xmini.Migrations
{
    ...
    [Migration("20251022140043_AddImageToTweet2")]
    partial class AddImageToTweet2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Xmini.Data.Followers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Xmini.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Xmini.Data.Followers", b =>
                {
                    b.HasOne("Xmini.Data.ApplicationUser", "FollowerUser")
                        .WithMany("Followers")
                        .HasForeignKey("FollowerUserId");

                    b.HasOne("Xmini.Data.ApplicationUser", "FollowsUser")
                        .WithMany("Following")
